...
public class TipeDataString {
    public static void main(String[] args) {
        ...
        String address = new String("Ngestiharjo Kasihan Bantul");
        ...
        String replacedName = fullName.replace("Ramadhan", "Hariwr"); // Menghasilkan "Hari Hariwr
        // Memotong string menjadi substring baru
        String firstNameSubstring = fullName.substring(0, 4); // Menghasilkan "Hari Wahyu"
